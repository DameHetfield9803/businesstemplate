...
export default function About() {
    return (
        <div className='space-y-1.5'>
            ...
            <Card className='dark:bg-slate-200 dark:text-black bg-black text-blue-50 w-fit px-1.5 mx-auto text-left'>
                <CardHeader>
                ...
                <CardContent>
                    <Image className='mx-auto rounded-xl z-20 shadow-inherit shadow-lg dark:shadow-blue-50' src={testImg} alt='Cat' width={200} height={72} />
                </CardContent>
                <CardFooter>
                    <p>Cute, isn't it?</p>
                </CardFooter>
